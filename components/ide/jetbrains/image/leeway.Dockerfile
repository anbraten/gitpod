...
COPY --chown=33333:33333 components-ide-jetbrains-cli--app/cli /ide-desktop/bin/cli
ENV GITPOD_ENV_APPEND_PATH /ide-desktop/bin:

# editor config
ENV GITPOD_ENV_SET_EDITOR "/ide-desktop/bin/cli open"
ENV GITPOD_ENV_SET_VISUAL "$GITPOD_ENV_SET_EDITOR"
ENV GITPOD_ENV_SET_GP_OPEN_EDITOR "$GITPOD_ENV_SET_EDITOR"
ENV GITPOD_ENV_SET_GIT_EDITOR "$GITPOD_ENV_SET_EDITOR --wait"
ENV GITPOD_ENV_SET_GP_PREVIEW_BROWSER "/ide-desktop/bin/cli preview"
ENV GITPOD_ENV_SET_GP_EXTERNAL_BROWSER "/ide-desktop/bin/cli preview"
