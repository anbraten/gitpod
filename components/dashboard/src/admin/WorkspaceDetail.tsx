        ...
        <div className="flex mt-6">
            <div className="flex flex-col w-full">
                <div className="flex w-full mt-6">
                    ...
                    <Property name="Context"><a className="text-blue-400 dark:text-blue-600 hover:text-blue-600 dark:hover:text-blue-400" href={ContextURL.getNormalized(workspace)}>{workspace.context.title}</a></Property>
                </div>
                <div className="flex w-full mt-6">
